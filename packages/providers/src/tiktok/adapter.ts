...
/**
 * TikTok — documented, not implemented.
 *
 ...
 * publish.
 */
export class TikTokProvider extends ProviderSkeleton {
  ...
  readonly blockedReason =
    'Unaudited apps can only post at private/self-only visibility. Audit is required before anything you publish here can be seen publicly.'
