...
/**
 * Blogger — documented, not implemented.
 *
 ...
 * publish.
 */
export class BloggerProvider extends ProviderSkeleton {
  readonly id = 'blogger' as const
  readonly label = 'Blogger'
  readonly capabilities = capabilities
  readonly limits = limits
  readonly media = media
  readonly text = text
  readonly blockedReason =
    'Not yet implemented. Needs a Google Cloud project with the Blogger API enabled.'
