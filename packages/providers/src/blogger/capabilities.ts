 ...
 * Blogger.
 *
 * SKELETON. Not yet implemented. Needs a Google Cloud project with the Blogger API enabled.
 *
...
export const limits = {
  publish: { cost: 1, window: '1m', budget: 20, unit: 'requests' },
  mediaUpload: { cost: 1, window: '1m', budget: 20, unit: 'requests' },
  read: { cost: 1, window: '1m', budget: 200, unit: 'requests' },
