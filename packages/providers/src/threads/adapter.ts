...
/**
 * Threads — documented, not implemented.
 *
 ...
 * publish.
 */
export class ThreadsProvider extends ProviderSkeleton {
  ...
  readonly blockedReason =
    'Requires a Meta app with the Threads API enabled and a linked Instagram account.'
