...
/**
 * LinkedIn (personal profile) — documented, not implemented.
 *
 ...
 * publish.
 */
export class LinkedInProvider extends ProviderSkeleton {
  readonly id = 'linkedin' as const
  readonly label = 'LinkedIn (personal profile)'
  readonly capabilities = capabilities
  readonly limits = limits
  readonly media = media
  readonly text = text
  readonly blockedReason =
    'Requires a LinkedIn app with the Share on LinkedIn product. Self-serve — no partner approval needed for personal profiles.'
