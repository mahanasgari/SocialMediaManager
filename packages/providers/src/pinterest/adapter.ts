...
/**
 * Pinterest — documented, not implemented.
 *
 ...
 * publish.
 */
export class PinterestProvider extends ProviderSkeleton {
  ...
  readonly blockedReason =
    'Trial access creates sandbox pins visible only to their creator. Standard access is required before pins are real.'
