...
/**
 * Instagram — documented, not implemented.
 *
 ...
 * publish.
 */
export class InstagramProvider extends ProviderSkeleton {
  ...
  readonly blockedReason =
    'Requires a Meta app, an Instagram Business or Creator account linked to a Facebook Page, and App Review.'
