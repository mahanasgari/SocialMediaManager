...
/**
 * LinkedIn Company Page — documented, not implemented.
 *
 ...
 * publish.
 */
export class LinkedInPageProvider extends ProviderSkeleton {
  readonly id = 'linkedinPage' as const
  readonly label = 'LinkedIn Company Page'
  readonly capabilities = capabilities
  readonly limits = limits
  readonly media = media
  readonly text = text
  readonly blockedReason =
    'Requires Marketing Developer Platform approval, which is a manual review with no published timeline. [A] Reports suggest 3-4 months.'
