 ...
 * publish.
 */
export class XProvider extends ProviderSkeleton {
  ...
  readonly blockedReason =
    'Requires an X developer account. Posting is PAID PER POST on the default tier — see the cost warning in the composer before enabling.'
