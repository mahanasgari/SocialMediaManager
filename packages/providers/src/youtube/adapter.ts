...
/**
 * YouTube — documented, not implemented.
 *
 ...
 * publish.
 */
export class YouTubeProvider extends ProviderSkeleton {
  ...
  readonly blockedReason =
    'Requires a Google Cloud project with the YouTube Data API enabled, plus an audit to lift the default upload quota.'
