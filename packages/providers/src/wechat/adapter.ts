...
/**
 * WeChat Official Account — documented, not implemented.
 *
 ...
 * publish.
 */
export class WeChatProvider extends ProviderSkeleton {
  readonly id = 'wechat' as const
  readonly label = 'WeChat Official Account'
  readonly capabilities = capabilities
  readonly limits = limits
  readonly media = media
  readonly text = text
  readonly blockedReason =
    'Requires a verified WeChat Official Account, which in most cases requires a mainland China business licence. There is no self-serve path for overseas operators.'
