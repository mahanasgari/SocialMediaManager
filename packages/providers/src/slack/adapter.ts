...
/**
 * Slack — documented, not implemented.
 *
 ...
 * publish.
 */
export class SlackProvider extends ProviderSkeleton {
  ...
  readonly blockedReason =
    'Not yet implemented. Needs a Slack app installed to your workspace — no review required for internal use.'
