...
/**
 * Google Business Profile — documented, not implemented.
 *
 ...
 * publish.
 */
export class GoogleBusinessProvider extends ProviderSkeleton {
  readonly id = 'googleBusiness' as const
  ...
  readonly blockedReason =
    'Requires a Google Cloud project with the Business Profile API enabled, plus per-project access approval from Google.'
